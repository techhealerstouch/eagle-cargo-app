...
class SettingSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        // The declaration form renders its full legal copy from
        // resources/data/declaration-terms.json. Keep the legacy editable
        // setting aligned with that document and Eagle Cargo branding.
        foreach ($settings as &$setting) {
            if ($setting['key'] === 'declaration_terms') {
                $setting['value'] = 'Eagle Cargo Terms and Conditions are displayed on the declaration form.';
            }

            if ($setting['key'] === 'declaration_brand_name') {
                $setting['value'] = 'Eagle Cargo Logistics System';
            }
        }
        unset($setting);
