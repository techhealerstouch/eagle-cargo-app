...
export default function SendersCreate() {
                ...
                <div className="flex flex-col md:flex-row md:items-start justify-between gap-6 border-b border-brand-warm/20 pb-8">
                    <div className="flex items-center gap-4">
                        ...
                        <Heading
                            ...
                            title="Register New Sender"
                            description="Create a sender profile for new bookings."
                        />
                    </div>
                </div>
                ...
                <div className="mt-8 max-w-4xl mx-auto w-full flex-1 card border-brand-warm/20 shadow-xl rounded-[2.5rem] bg-white overflow-hidden">
                    <div className="bg-brand-warm/5 p-8 border-b border-brand-warm/10 flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-2 bg-white px-4 py-2 rounded-xl border border-brand-warm/20 shadow-sm">
                            ...
                            <span className="text-[10px] font-black uppercase tracking-widest text-brand-rust">VERIFIED INPUT</span>
                        </div>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="p-8 md:p-12 space-y-10">
                        <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
                            ...
                            {/* Email */}
                            <div className="space-y-3">
                                <Label htmlFor="email" className="text-[10px] font-black uppercase tracking-[0.2em] text-muted-foreground ml-1">Contact Email Address</Label>
                                <div className="relative">
                            ...
                            {/* Mobile */}
                            <div className="space-y-3">
                                <Label htmlFor="mobile" className="text-[10px] font-black uppercase tracking-[0.2em] text-muted-foreground ml-1">Mobile Number</Label>
                                <PhoneInput
                                    value={data.mobile || ''}
                            ...
                            {/* State & Postcode grouped theoretically but we use grid */}
                            <div className="grid grid-cols-2 gap-4">
                                <div className="space-y-3">
                                    <Label htmlFor="state" className="text-[10px] font-black uppercase tracking-[0.2em] text-muted-foreground ml-1">State / Prov.</Label>
                                    <Input
                                        id="state"
                        ...
                        <div className="flex justify-end gap-5 pt-10 border-t border-brand-warm/10">
                            ...
                            >
                                ...
                                {processing ? 'SAVING...' : 'REGISTER SENDER'}
                            </Button>
                        </div>
                    </form>
                </div>
