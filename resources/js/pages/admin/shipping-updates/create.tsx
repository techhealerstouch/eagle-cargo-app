...
export default function ShippingUpdatesCreate() {
    ...
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        { title: 'New Official Notice', href: '#' },
    ];

    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        post('/admin/shipping-updates');
    };

    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Post Shipping Update | Admin" />
            <div className="flex h-full flex-1 flex-col gap-4 p-8">
                ...
                <div className="flex flex-col md:flex-row md:items-start justify-between gap-6 border-b border-brand-warm/20 pb-8">
                    <div className="flex items-center gap-4">
                        ...
                        <Heading
                            ...
                            description="Share shipping updates, delays, or general announcements."
                        />
                    </div>
                </div>
                ...
                <div className="mt-8 max-w-3xl mx-auto w-full flex-1 card card-padding border-brand-warm/20 shadow-sm rounded-3xl bg-white">
                    <div className="mb-10 flex items-center gap-3">
                        ...
                        <h2 className="font-serif text-xl font-bold text-brand-rust uppercase tracking-tight">Bulletin Details</h2>
                    </div>
                        ...
                        <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                            ...
                            <div className="space-y-2">
                                ...
                                <Input
                                    ...
                                    placeholder="e.g. Vessel departure schedule change"
