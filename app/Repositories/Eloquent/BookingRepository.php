        ...
        return DB::transaction(function () use ($data, $sender) {
            if ($sender) {
                $sender->update([
                    ...
                    'email' => $data['email'],
                    'mobile' => $data['mobile'],
                    'secondary_mobile' => $data['secondary_mobile'] ?? $sender->secondary_mobile,
            ...
            if ($firstName && $lastName && $address) {
                ...
                if ($candidate) {
                    $candidate->update([
                        ...
                        'secondary_phone_number' => $firstBox['recipient_secondary_phone'] ?? $candidate->secondary_phone_number,
                        'address' => $address,
